...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double X_MULTIPLIER = 0.9919701333; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 0.9965915333; // Multiplier in the Y direction
